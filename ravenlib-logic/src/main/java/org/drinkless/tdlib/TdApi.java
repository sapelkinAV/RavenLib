...
public class TdApi {
    ...
    /**
     * A request to send a message has reached the Telegram server. This doesn't mean that the message will be sent successfully or even that the send message request will be processed. This org.sapelkinav.client.handlers will be sent only if the option &quot;useQuickAck&quot; is set to true. This org.sapelkinav.client.handlers may be sent multiple times for the same message.
     */
    ...
    /**
     * A message failed to send. Be aware that some messages being sent can be irrecoverably deleted, in which case updateDeleteMessages will be received instead of this org.sapelkinav.client.handlers.
     */
    ...
    /**
     * A new chat has been loaded/created. This org.sapelkinav.client.handlers is guaranteed to come before the chat identifier is returned to the client. The chat field changes will be reported through separate updates.
     */
    ...
    /**
     * The order of the chat in the chats list has changed. Instead of this org.sapelkinav.client.handlers updateChatLastMessage, updateChatIsPinned or updateChatDraftMessage might be sent.
     */
    ...
    /**
     * A draft has changed. Be aware that the org.sapelkinav.client.handlers may come in the currently opened chat but with old content of the draft. If the user has changed the content of the draft, this org.sapelkinav.client.handlers shouldn't be applied.
     */
    ...
    /**
     * Some data of a user has changed. This org.sapelkinav.client.handlers is guaranteed to come before the user identifier is returned to the client.
     */
    ...
    /**
     * Some data of a basic group has changed. This org.sapelkinav.client.handlers is guaranteed to come before the basic group identifier is returned to the client.
     */
    ...
    /**
     * Some data of a supergroup or a channel has changed. This org.sapelkinav.client.handlers is guaranteed to come before the supergroup identifier is returned to the client.
     */
    ...
    /**
     * Some data of a secret chat has changed. This org.sapelkinav.client.handlers is guaranteed to come before the secret chat identifier is returned to the client.
     */
    ...
    /**
     * Number of unread messages has changed. This org.sapelkinav.client.handlers is sent only if a message database is used.
     */
    ...
    /**
     * This method should be called if the message content has been opened (e.g., the user has opened a photo, video, document, location or venue, or has listened to an audio file or voice note message). An updateMessageContentOpened org.sapelkinav.client.handlers will be generated if something has changed.
     *
     * <p> Returns {@link Ok Ok} </p>
     */
    ...
    public static class SetGameScore extends Function {
        ...
        public int score;
        /**
         * Pass true to org.sapelkinav.client.handlers the score even if it decreases. If the score is 0, the user will be deleted from the high score table.
         */
        public boolean force;
         ...
         * @param force Pass true to org.sapelkinav.client.handlers the score even if it decreases. If the score is 0, the user will be deleted from the high score table.
         */
